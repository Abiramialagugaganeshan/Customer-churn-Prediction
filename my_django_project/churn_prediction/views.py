...
def form(request):
    return render(request, 'churn_prediction/form.html', {'dropdown_mappings': dropdown_mappings, 'feature_descriptions': feature_descriptions})
...
def predict(request):
    if request.method == 'POST':
        ...
        return render(request, 'churn_prediction/results.html', {'results': results, 'form_data': form_data, 'feature_descriptions': feature_descriptions})
